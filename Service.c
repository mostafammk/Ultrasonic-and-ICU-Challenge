...
uint8 Delay(uint8 TIMER_ID,uint64 Delay_ms)
{
	...
	for(Loop_index=0;Loop_index<NUM_OF_Timers;Loop_index++)
	{
		if(TIMER_cnfg_arr[Loop_index].TIMER_ID==TIMER_ID)
		{
			...
			{
			case F_CPU_1:
				Tick_Time= (1.0/ F_CPU)*1000000;
				break;
			case F_CPU_8:
				Tick_Time= (8.0/ F_CPU)*1000000;
				break;
			case F_CPU_32:
				Tick_Time= (32.0/ F_CPU)*1000000;
				break;
			case F_CPU_64:
				Tick_Time= (64.0/ F_CPU)*1000000;
				break;
			case F_CPU_128:
				Tick_Time= (128.0/ F_CPU)*1000000;
				break;
			case F_CPU_256:
				Tick_Time= (256.0/ F_CPU)*1000000;
				break;
			case F_CPU_1024:
				Tick_Time= (1024.0/ F_CPU)*1000000;
				break;
			default:
				retval=NOK;
				break;
